;;; magik-completion-extras.el --- This file adds hooks and session names for the classbrowser to start to the original magik-mode.  -*- lexical-binding: t; -*-
...
(provide 'magik-completion-extras)
;;; magik-completion-extras.el ends here
