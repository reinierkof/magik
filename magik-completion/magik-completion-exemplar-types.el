;;; magik-completion-exemplar-types.el --- This file contains all the functions which are related to extracting which type a variable might be.  -*- lexical-binding: t; -*-
...
;; 	   ((cl-loop for (type regex) in magik-completion--typed-assignment-patterns
;; 		     for match = (let ((result (magik-completion--check-assignment-and-type variable regex type)))
;; 			     result)
;; 		     when match return match))
...
(provide 'magik-completion-exemplar-types)
;;; magik-completion-exemplar-types.el ends here
